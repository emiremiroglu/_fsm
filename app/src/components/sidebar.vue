...
<template>
    <div class="flex flex-col gap-10 overflow-y-auto bg-gray-200 p-4 md:p-6 md:pb-0 h-auto md:h-screen">
        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" class="space-y-2">
              <li>
                <router-link to="/" class="group flex items-center gap-2 rounded-md p-2 text-sm font-semibold">
              ...
              <li>
                <router-link to="/conversion_trackers" class="group flex items-center gap-2 rounded-md p-2 pr-4 text-sm font-semibold ">
                  <svg class="h-6 w-6 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <li class="-mx-6 mt-auto">
            <a href="#" class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold">
